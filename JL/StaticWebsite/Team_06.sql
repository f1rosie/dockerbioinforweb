CREATE DATABASE  IF NOT EXISTS `team_6` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `team_6`;
-- MySQL dump 10.13  Distrib 5.6.24, for osx10.8 (x86_64)
--
-- Host: 127.0.0.1    Database: team_6
-- ------------------------------------------------------
...
--
-- Temporary view structure for view `all_protein_table`
--

DROP TABLE IF EXISTS `all_protein_table`;
/*!50001 DROP VIEW IF EXISTS `all_protein_table`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `all_protein_table` AS SELECT 
 ...
 1 AS `Phenotype_MIM_No`,
 1 AS `DOID`,
 1 AS `Disease_Name`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `assignment4_1`
--

DROP TABLE IF EXISTS `assignment4_1`;
/*!50001 DROP VIEW IF EXISTS `assignment4_1`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `assignment4_1` AS SELECT 
 1 AS `Targeted_Disease`,
 1 AS `UniProtKB_Entry`,
 1 AS `Protein_Name`,
 1 AS `HGNC_ID`,
...
--
-- Temporary view structure for view `diabetes_involved_disease_table`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `diabetes_involved_disease_table` AS SELECT 
 1 AS `DOID`,
 1 AS `Disease_Name`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `diabetes_table`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `diabetes_table` AS SELECT 
 1 AS `Targeted_Disease`,
 1 AS `UniProtKB_Entry`,
 1 AS `Protein_Name`,
 1 AS `Sequence_Length`,
...
--
-- Temporary view structure for view `distinct_phynotype_table`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `distinct_phynotype_table` AS SELECT 
 1 AS `Phenotype_MIM_No`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `distinct_protein_table`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `distinct_protein_table` AS SELECT 
 1 AS `UniProtKB_Entry`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `foreign_key_error_count`
--

DROP TABLE IF EXISTS `foreign_key_error_count`;
/*!50001 DROP VIEW IF EXISTS `foreign_key_error_count`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `foreign_key_error_count` AS SELECT 
 1 AS `N_HGNC_ID`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `full_table`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `full_table` AS SELECT 
 1 AS `Targeted_Disease`,
 1 AS `UniProtKB_Entry`,
 1 AS `Protein_Name`,
 1 AS `Sequence_Length`,
...
--
-- Temporary view structure for view `gene_location_table`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `gene_location_table` AS SELECT 
 1 AS `HGNC_ID`,
 1 AS `Chromosomal_Location`,
 1 AS `Targeted_Disease`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `pancreas_disease_involved_disease_table`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `pancreas_disease_involved_disease_table` AS SELECT 
 1 AS `DOID`,
 1 AS `Disease_Name`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `pancreas_disease_table`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `pancreas_disease_table` AS SELECT 
 1 AS `Targeted_Disease`,
 1 AS `UniProtKB_Entry`,
 1 AS `Protein_Name`,
 1 AS `Sequence_Length`,
...
--
-- Temporary view structure for view `phenotype_protein_table`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `phenotype_protein_table` AS SELECT 
 1 AS `Phenotype_MIM_No`,
...
--
-- Temporary view structure for view `protein_alternative`
--

DROP TABLE IF EXISTS `protein_alternative`;
/*!50001 DROP VIEW IF EXISTS `protein_alternative`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `protein_alternative` AS SELECT 
 1 AS `Targeted_Disease`,
 1 AS `UniProtKB_Entry`,
 1 AS `Protein_Name`,
 1 AS `HGNC_ID`,
...
--
-- Temporary view structure for view `protein_disease_onthology`
--

DROP TABLE IF EXISTS `protein_disease_onthology`;
/*!50001 DROP VIEW IF EXISTS `protein_disease_onthology`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `protein_disease_onthology` AS SELECT 
 1 AS `Targeted_Disease`,
 1 AS `UniProtKB_Entry`,
 1 AS `Protein_Name`,
 1 AS `HGNC_ID`,
...
--
-- Temporary view structure for view `protein_disease_onthology_gene`
--

DROP TABLE IF EXISTS `protein_disease_onthology_gene`;
/*!50001 DROP VIEW IF EXISTS `protein_disease_onthology_gene`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `protein_disease_onthology_gene` AS SELECT 
 1 AS `Targeted_Disease`,
 1 AS `UniProtKB_Entry`,
 1 AS `Protein_Name`,
 1 AS `HGNC_ID`,
...
--
-- Temporary view structure for view `protein_disease_table`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `protein_disease_table` AS SELECT 
 1 AS `UniProtKB_Entry`,
 1 AS `Protein_Name`,
 1 AS `DOID`,
 1 AS `Disease_Name`*/;
...
--
-- Temporary view structure for view `protein_do_table`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `protein_do_table` AS SELECT 
 1 AS `UniProtKB_Entry`,
 1 AS `Protein_Name`,
 1 AS `DOID`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `protein_omim`
--

DROP TABLE IF EXISTS `protein_omim`;
/*!50001 DROP VIEW IF EXISTS `protein_omim`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `protein_omim` AS SELECT 
 1 AS `Targeted_Disease`,
 1 AS `UniProtKB_Entry`,
 1 AS `Protein_Name`,
 1 AS `HGNC_ID`,
...
--
-- Temporary view structure for view `protein_omim_do`
--

DROP TABLE IF EXISTS `protein_omim_do`;
/*!50001 DROP VIEW IF EXISTS `protein_omim_do`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `protein_omim_do` AS SELECT 
 1 AS `Targeted_Disease`,
 1 AS `UniProtKB_Entry`,
 1 AS `Protein_Name`,
 1 AS `HGNC_ID`,
...
--
-- Temporary view structure for view `protein_synonym_table`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `protein_synonym_table` AS SELECT 
 1 AS `UniProtKB_Entry`,
 1 AS `Protein_Name`,
 1 AS `Alternative_Name`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Dumping routines for database 'team_6'
--
/*!50003 DROP PROCEDURE IF EXISTS `Diabetes_Related_Disease` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Diabetes_Related_Disease`()
begin
/*
In this case, we want to know all the other diseases related to one sepecific target disease.
Here we take diabetes as our target disease, building a store procedure to return all the related diseases.
*/
select distinct DOID,Disease_Name from diabetes_table;
end ;;
DELIMITER ;
...
/*!50003 DROP PROCEDURE IF EXISTS `Differences_Count` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Differences_Count`()
begin
/*
Since one protein has at least one phynotype and we want to know the number of overlapping.
We can just cout the number of distinct phynotype and the number of distinct protein, then the difference should be the number of overlapping.
*/
select count(distinct Phenotype_MIM_No) as Number_Of_Distinct_Phenotype, 
count(distinct UniProtKB_Entry) as Number_Of_Distinct_Protein,
count(distinct Phenotype_MIM_No) - count(distinct UniProtKB_Entry) as Number_Of_Differences
from phenotype_protein_table;
end ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `Full_View` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Full_View`()
begin
/*
We use store procedure and call statement to test our merged table.
First we put out all the 11 columns and all the rows in table to check if there are any mistakes or Missing records. 
*/
select * from protein_disease_onthology_gene;
end ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `Gene_Location_For_Colon_Cancer` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Gene_Location_For_Colon_Cancer`()
begin
/*
In order to check all the gene locations related back to one target disease,
we group all the locations together and create a view.
To check this out, we use store procedure to show all the gene locations related to one target disease.
In this procedure, we are concentrate on colon cancer.
*/
select * from gene_location_table where Targeted_Disease = 'colon cancer';
end ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `Gene_Location_For_Diabetes` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Gene_Location_For_Diabetes`()
begin
/*
In order to check all the gene locations related back to one target disease,
we group all the locations together and create a view.
To check this out, we use store procedure to show all the gene locations related to one target disease.
In this procedure, we are concentrate on Diabetes.
*/
select * from gene_location_table where Targeted_Disease = 'diabetes';
end ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `Gene_Location_For_Pancreas_Disease` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Gene_Location_For_Pancreas_Disease`()
begin
/*
In order to check all the gene locations related back to one target disease,
we group all the locations together and create a view.
To check this out, we use store procedure to show all the gene locations related to one target disease.
In this procedure, we are concentrate on Pancreas Disease.
*/
select * from gene_location_table where Targeted_Disease = 'Pancreas Disease';
end ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `Overlapping_Count` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Overlapping_Count`()
begin
/*
Since one protein has at least one phynotype and we want to know the number of overlapping.
We can just cout the number of distinct phynotype and the number of distinct protein, then the difference should be the number of overlapping.
...
select count(distinct Phenotype_MIM_No) as Number_Of_Distinct_Phenotype, 
count(distinct UniProtKB_Entry) as Number_Of_Distinct_Protein,
count(distinct Phenotype_MIM_No) - count(distinct UniProtKB_Entry) as Number_Of_Overlapping
from phenotype_protein_table;
end ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `Pancreas_Disease_Related_Disease` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Pancreas_Disease_Related_Disease`()
begin
/*
In this case, we want to know all the other diseases related to one sepecific target disease.
Here we take pancreas disease as our target disease, building a store procedure to return all the related diseases.
*/
select distinct DOID,Disease_Name from pancreas_disease_table;
end ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `Protein_Feature` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Protein_Feature`()
begin
/*
In this store procedure, we want to return basic features of proteins.
The features are sequence length and alternative name.
*/
select distinct UniProtKB_Entry, Protein_Name, Sequence_Length, Alternative_Name
from full_table;
end ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `Protein_Related_Disease` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Protein_Related_Disease`()
begin
/*
Create a store procedure to show the relationship between protein and involved diseases.
Since we built the database, we have already known that each protein may have more than one involved diseases.
So in this table, we are going to we seprate proteins which have more than one involved diseases to show all the diseases clearly.
*/
select distinct UniProtKB_Entry, Protein_Name, DOID, Disease_Name from protein_disease_table;
end ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `Protein_Related_Information` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Protein_Related_Information`()
begin
/*
In this store procedure, we want to return related information of proteins.
The features are concentrated on genes or diseases.
*/
select distinct UniProtKB_Entry, Protein_Name,
HGNC_ID, Approved_Symbol, Chromosomal_Location, Phenotype_MIM_No, DOID, Disease_Name
from full_table;
end ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `Protein_Synonym` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Protein_Synonym`()
begin
/*
In order to see the similarities among all the names for one protein,
we group all the names together and create a view.
To check this out, we use store procedure to show all the alternative names related to one protein.
And we sort all data by UniProtKB_Entry so that data for one protein are grouped together.
*/
select * from protein_synonym_table;
end ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `ThreeRows_EachTargetDisease_View` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `ThreeRows_EachTargetDisease_View`()
begin
/*
We use store procedure and call statement to test our merged table.
Second we put out all the 11 columns and all 3 rows for each target diseases in table to check as examples. 
*/
select * from Assignment4_1;
end ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
--
-- Final view structure for view `all_protein_table`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `assignment4_1` AS (select `protein_disease_onthology_gene`.`Targeted_Disease` AS `Targeted_Disease`,`protein_disease_onthology_gene`.`UniProtKB_Entry` AS `UniProtKB_Entry`,`protein_disease_onthology_gene`.`Protein_Name` AS `Protein_Name`,`protein_disease_onthology_gene`.`HGNC_ID` AS `HGNC_ID`,`protein_disease_onthology_gene`.`Sequence_Length` AS `Sequence_Length`,`protein_disease_onthology_gene`.`Alternative_Name` AS `Alternative_Name`,`protein_disease_onthology_gene`.`Phenotype_MIM_No` AS `Phenotype_MIM_No`,`protein_disease_onthology_gene`.`DOID` AS `DOID`,`protein_disease_onthology_gene`.`Disease_Name` AS `Disease_Name`,`protein_disease_onthology_gene`.`Approved_Symbol` AS `Approved_Symbol`,`protein_disease_onthology_gene`.`Chromosomal_Location` AS `Chromosomal_Location` from `protein_disease_onthology_gene` where (`protein_disease_onthology_gene`.`Targeted_Disease` like 'diabetes') limit 3) union all (select `protein_disease_onthology_gene`.`Targeted_Disease` AS `Targeted_Disease`,`protein_disease_onthology_gene`.`UniProtKB_Entry` AS `UniProtKB_Entry`,`protein_disease_onthology_gene`.`Protein_Name` AS `Protein_Name`,`protein_disease_onthology_gene`.`HGNC_ID` AS `HGNC_ID`,`protein_disease_onthology_gene`.`Sequence_Length` AS `Sequence_Length`,`protein_disease_onthology_gene`.`Alternative_Name` AS `Alternative_Name`,`protein_disease_onthology_gene`.`Phenotype_MIM_No` AS `Phenotype_MIM_No`,`protein_disease_onthology_gene`.`DOID` AS `DOID`,`protein_disease_onthology_gene`.`Disease_Name` AS `Disease_Name`,`protein_disease_onthology_gene`.`Approved_Symbol` AS `Approved_Symbol`,`protein_disease_onthology_gene`.`Chromosomal_Location` AS `Chromosomal_Location` from `protein_disease_onthology_gene` where (`protein_disease_onthology_gene`.`Targeted_Disease` like 'Pancreas Disease') limit 3) union all (select `protein_disease_onthology_gene`.`Targeted_Disease` AS `Targeted_Disease`,`protein_disease_onthology_gene`.`UniProtKB_Entry` AS `UniProtKB_Entry`,`protein_disease_onthology_gene`.`Protein_Name` AS `Protein_Name`,`protein_disease_onthology_gene`.`HGNC_ID` AS `HGNC_ID`,`protein_disease_onthology_gene`.`Sequence_Length` AS `Sequence_Length`,`protein_disease_onthology_gene`.`Alternative_Name` AS `Alternative_Name`,`protein_disease_onthology_gene`.`Phenotype_MIM_No` AS `Phenotype_MIM_No`,`protein_disease_onthology_gene`.`DOID` AS `DOID`,`protein_disease_onthology_gene`.`Disease_Name` AS `Disease_Name`,`protein_disease_onthology_gene`.`Approved_Symbol` AS `Approved_Symbol`,`protein_disease_onthology_gene`.`Chromosomal_Location` AS `Chromosomal_Location` from `protein_disease_onthology_gene` where (`protein_disease_onthology_gene`.`Targeted_Disease` like 'colon cancer') limit 3) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
--
-- Final view structure for view `foreign_key_error_count`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `foreign_key_error_count` AS select count(0) AS `N_HGNC_ID` from (`protein` `a` left join `gene` `b` on((`a`.`HGNC_ID` = `b`.`HGNC_ID`))) where isnull(`b`.`HGNC_ID`) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
--
-- Final view structure for view `protein_alternative`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `protein_alternative` AS select `p`.`Targeted_Disease` AS `Targeted_Disease`,`p`.`UniProtKB_Entry` AS `UniProtKB_Entry`,`p`.`Protein_Name` AS `Protein_Name`,`p`.`HGNC_ID` AS `HGNC_ID`,`p`.`Sequence_Length` AS `Sequence_Length`,group_concat(distinct `ps`.`Alternative_Name` separator ',') AS `Alternative_Name` from (`protein` `p` left join `protein_synonym` `ps` on((`p`.`UniProtKB_Entry` = `ps`.`UniProtKB_Entry`))) group by `p`.`UniProtKB_Entry` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `protein_disease_onthology`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `protein_disease_onthology` AS select `pod`.`Targeted_Disease` AS `Targeted_Disease`,`pod`.`UniProtKB_Entry` AS `UniProtKB_Entry`,`pod`.`Protein_Name` AS `Protein_Name`,`pod`.`HGNC_ID` AS `HGNC_ID`,`pod`.`Sequence_Length` AS `Sequence_Length`,`pod`.`Alternative_Name` AS `Alternative_Name`,`pod`.`Phenotype_MIM_No` AS `Phenotype_MIM_No`,`pod`.`DOID` AS `DOID`,`diso`.`Disease_Name` AS `Disease_Name` from (`protein_omim_do` `pod` join `disease_ontology` `diso` on((`pod`.`DOID` = `diso`.`DOID`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `protein_disease_onthology_gene`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `protein_disease_onthology_gene` AS select `pdo`.`Targeted_Disease` AS `Targeted_Disease`,`pdo`.`UniProtKB_Entry` AS `UniProtKB_Entry`,`pdo`.`Protein_Name` AS `Protein_Name`,`pdo`.`HGNC_ID` AS `HGNC_ID`,`pdo`.`Sequence_Length` AS `Sequence_Length`,`pdo`.`Alternative_Name` AS `Alternative_Name`,`pdo`.`Phenotype_MIM_No` AS `Phenotype_MIM_No`,`pdo`.`DOID` AS `DOID`,`pdo`.`Disease_Name` AS `Disease_Name`,`g`.`Approved_Symbol` AS `Approved_Symbol`,`g`.`Chromosomal_Location` AS `Chromosomal_Location` from (`protein_disease_onthology` `pdo` join `gene` `g` on((`pdo`.`HGNC_ID` = `g`.`HGNC_ID`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
--
-- Final view structure for view `protein_omim`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `protein_omim` AS select `pa`.`Targeted_Disease` AS `Targeted_Disease`,`pa`.`UniProtKB_Entry` AS `UniProtKB_Entry`,`pa`.`Protein_Name` AS `Protein_Name`,`pa`.`HGNC_ID` AS `HGNC_ID`,`pa`.`Sequence_Length` AS `Sequence_Length`,`pa`.`Alternative_Name` AS `Alternative_Name`,`m`.`Phenotype_MIM_No` AS `Phenotype_MIM_No` from (`protein_alternative` `pa` join `uniprot_omim_relationship` `m` on((`pa`.`UniProtKB_Entry` = `m`.`UniProtKB_Entry`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `protein_omim_do`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `protein_omim_do` AS select `po`.`Targeted_Disease` AS `Targeted_Disease`,`po`.`UniProtKB_Entry` AS `UniProtKB_Entry`,`po`.`Protein_Name` AS `Protein_Name`,`po`.`HGNC_ID` AS `HGNC_ID`,`po`.`Sequence_Length` AS `Sequence_Length`,`po`.`Alternative_Name` AS `Alternative_Name`,`po`.`Phenotype_MIM_No` AS `Phenotype_MIM_No`,`dod`.`DOID` AS `DOID` from (`protein_omim` `po` join `uniprot_omim_do_relationship` `dod` on((`po`.`UniProtKB_Entry` = `dod`.`UniProtKB_Entry`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2015-11-08 17:34:51
